...
# Use a stack for the purpose. Each piece of clothing has its value (an integer). You must sum their values, while you take them out of the box:
...
for i in range(len(clothes)):
    cloth = clothes.pop()
    if cloth + current_capacity > capacity:
        n_racks += 1
        current_capacity = 0
