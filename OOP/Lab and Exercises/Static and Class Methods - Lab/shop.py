...
# The store should also have an attribute called items (an empty dictionary that stores the name of an item and its quantity). The class should have 4 methods:
...
class Shop:
    ...
    def add_item(self, item_name: str):
        current_occupied = sum([el for el in self.items.values()])
